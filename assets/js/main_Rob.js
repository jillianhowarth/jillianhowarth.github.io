...
var locationData = {
			buildingLocation: "", 
			studySpot: "", 
			dataCollector: "Rob",	//TODO: update for each person
			latitude: "",
			longitude: "",
		};
		...
		ws.onopen = function() {
    		ws.send("81574af7aeae678e43c58213288f4aec");
		};
	...
	function collectData(asynchCheck){
			...
			xhttp.open("GET", "https://us.wio.seeed.io/v1/node/GroveSoundA0/sound_level?access_token=81574af7aeae678e43c58213288f4aec", true); 
			xhttp.send();
			//}, 1000);
		//console.log("Sound!");
	...
	function collectLightData(){
			...
			xhttp.open("GET", "https://us.wio.seeed.io/v1/node/GroveLuminanceA0/luminance?access_token=138e0a478f276ea4b642b6642315782e", true);
			xhttp.send();
			//}, 1000);
...
function download_csv_button() {
    ...
    var d = new Date();
    var date = d.toLocaleString();
    var docName = "button " + date + " tisch_rob";
...
function download_csv_sound() {
    ...
    var d = new Date();
    var date = d.toLocaleString();
    var docName = "sound " + date + " tisch_rob";
...
function download_csv_light() {
    ...
    var d = new Date();
    var date = d.toLocaleString();
    var docName = "light " + date + " tisch_rob";
